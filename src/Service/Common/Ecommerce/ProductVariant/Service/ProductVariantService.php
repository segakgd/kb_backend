...
namespace App\Service\Common\Ecommerce\ProductVariant\Service;

use App\Controller\Admin\Product\DTO\Request\ProductVariantRequest;
...
readonly class ProductVariantService
{
    ...
    public function handleBatchUpdate(Product $product, array $variantsRequestDto): Product
    {
        ...
        /** @var ProductVariantRequest $variantDto */
