...
final class Version20240406141915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bot (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type VARCHAR(50) NOT NULL, token VARCHAR(255) NOT NULL, project_id INTEGER NOT NULL, name VARCHAR(50) NOT NULL, active BOOLEAN DEFAULT NULL, webhook_uri VARCHAR(100) DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(100) NOT NULL, status VARCHAR(20) DEFAULT NULL, active_from DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        ...
        $this->addSql('CREATE TABLE scenario (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, uuid VARCHAR(36) NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(25) NOT NULL, project_id INTEGER NOT NULL, bot_id INTEGER DEFAULT NULL, steps CLOB DEFAULT NULL --(DC2Type:scenario_step_dto_array)
