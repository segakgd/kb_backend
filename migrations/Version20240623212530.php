 ...
 */
final class Version20240623212530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visitor_event ADD COLUMN session_id INTEGER NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO visitor_event (id, type, status, project_id, error, created_at, scenario_uuid, responsible) SELECT id, type, status, project_id, error, created_at, scenario_uuid, responsible FROM __temp__visitor_event');
