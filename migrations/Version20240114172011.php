 ...
 */
final class Version20240114172011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visitor_session ADD COLUMN project_id INTEGER DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE visitor_event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type VARCHAR(255) NOT NULL, behavior_scenario INTEGER NOT NULL, action_before CLOB DEFAULT NULL --(DC2Type:json)
        , action_after CLOB DEFAULT NULL --(DC2Type:json)
        , status VARCHAR(15) NOT NULL, created_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO visitor_event (id, type, behavior_scenario, action_before, action_after, status, created_at) SELECT id, type, behavior_scenario, action_before, action_after, status, created_at FROM __temp__visitor_event');
        $this->addSql('DROP TABLE __temp__visitor_event');
        ...
        $this->addSql('CREATE TABLE visitor_session (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, channel VARCHAR(30) NOT NULL, channel_id INTEGER NOT NULL, visitor_id INTEGER DEFAULT NULL, visitor_event INTEGER DEFAULT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        )');
