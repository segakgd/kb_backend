 ...
 */
final class Version20240811125955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , type VARCHAR(20) NOT NULL, session VARCHAR(255) NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        , images CLOB NOT NULL --(DC2Type:json)
        , type VARCHAR(20) NOT NULL, CONSTRAINT FK_B7324A47613FECDF FOREIGN KEY (session_id) REFERENCES session (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO message_history (id, message, key_board, images, type) SELECT id, message, key_board, images, type FROM __temp__message_history');
        $this->addSql('DROP TABLE __temp__message_history');
