 ...
 */
final class Version20240407202721 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE deal_order_product_variant (deal_order_id INTEGER NOT NULL, product_variant_id INTEGER NOT NULL, PRIMARY KEY(deal_order_id, product_variant_id), CONSTRAINT FK_D013B5576E187CA2 FOREIGN KEY (deal_order_id) REFERENCES deal_order (id) ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D013B557A80EF684 FOREIGN KEY (product_variant_id) REFERENCES product_variant (id) ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE deal_order_promotion (deal_order_id INTEGER NOT NULL, promotion_id INTEGER NOT NULL, PRIMARY KEY(deal_order_id, promotion_id), CONSTRAINT FK_39A47C316E187CA2 FOREIGN KEY (deal_order_id) REFERENCES deal_order (id) ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_39A47C31139DF194 FOREIGN KEY (promotion_id) REFERENCES promotion (id) ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE deal_order_shipping (deal_order_id INTEGER NOT NULL, shipping_id INTEGER NOT NULL, PRIMARY KEY(deal_order_id, shipping_id), CONSTRAINT FK_F6B39EF96E187CA2 FOREIGN KEY (deal_order_id) REFERENCES deal_order (id) ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F6B39EF94887F3F8 FOREIGN KEY (shipping_id) REFERENCES shipping (id) ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
